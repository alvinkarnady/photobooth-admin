    ...
    <>
      ...
      <main className="flex-grow w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-16 pb-32">
        ...
        <section className="mb-20 md:mb-32 max-w-3xl">
          <h1 className="font-display-mobile text-display-mobile md:font-display-lg md:text-display-lg text-primary mb-6">{t('title')}</h1>
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-gutter space-y-gutter">
          ...
          <div className="break-inside-avoid mb-gutter">
            <div className="ink-hover-container matte-border border border-outline-variant cursor-pointer group">
              ...
              <div className="ink-hover-content">
                <h3 className="font-headline-sm text-headline-sm mb-1">{t('item1Title')}</h3>
                <p className="font-label-sm text-label-sm uppercase tracking-widest opacity-80">{t('item1Desc')}</p>
              </div>
            </div>
          </div>
          {/* Item 2 (Square) */}
          <div className="break-inside-avoid mb-gutter">
            <div className="ink-hover-container matte-border border border-outline-variant cursor-pointer group">
              ...
              <div className="ink-hover-content">
                <h3 className="font-headline-sm text-headline-sm mb-1">{t('item2Title')}</h3>
                <p className="font-label-sm text-label-sm uppercase tracking-widest opacity-80">{t('item2Desc')}</p>
              </div>
            </div>
          </div>
          {/* Item 3 (Wide) */}
          <div className="break-inside-avoid mb-gutter">
            <div className="ink-hover-container matte-border border border-outline-variant cursor-pointer group">
              ...
              <div className="ink-hover-content">
                <h3 className="font-headline-sm text-headline-sm mb-1">{t('item3Title')}</h3>
                <p className="font-label-sm text-label-sm uppercase tracking-widest opacity-80">{t('item3Desc')}</p>
              </div>
            </div>
          </div>
          {/* Item 4 (Square) */}
          <div className="break-inside-avoid mb-gutter">
            <div className="ink-hover-container matte-border border border-outline-variant cursor-pointer group">
              ...
              <div className="ink-hover-content">
                <h3 className="font-headline-sm text-headline-sm mb-1">{t('item4Title')}</h3>
                <p className="font-label-sm text-label-sm uppercase tracking-widest opacity-80">{t('item4Desc')}</p>
              </div>
            </div>
          </div>
          {/* Item 5 (Tall) */}
          <div className="break-inside-avoid mb-gutter">
            <div className="ink-hover-container matte-border border border-outline-variant cursor-pointer group">
              ...
              <div className="ink-hover-content">
                <h3 className="font-headline-sm text-headline-sm mb-1">{t('item5Title')}</h3>
                <p className="font-label-sm text-label-sm uppercase tracking-widest opacity-80">{t('item5Desc')}</p>
              </div>
            </div>
          </div>
          {/* Item 6 (Wide) */}
